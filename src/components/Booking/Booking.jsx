...
const Booking = () => {
  ...
  if (booking.length === 0) {
    ...
    checkTotalPrice = booking[0].Airplane.Price;
  }
  ...
  async function bookingOne(datas) {
    try {
      let Session = await axios({
        method: "post",
        url: "https://parisairwaysversionone.onrender.com/ParisAirways/v1/checkoutPage",
        data: {
          datas,
          result,
        },
            ...
            <div className="container-fluid ">
              <div className="row">
                {booking.map((data, ind) => (
                  <div
                    key={ind}
                    className="col-sm-12 p-4 d-xl-flex d-md-flex gap-xl-4 gap-md-4 justify-content-md-around justify-content-xl-around"
                  >
                        ...
                        <div className="">
                          ...
                          <div className="p-2 shadow-lg">
                            <div className="col-sm-12">
                              ...
                              <p>
                                🧳 Check In Baggage: 15 Kgs (1 piece only)/
                                Adult
                              </p>
                            </div>
                          </div>
